// Enable definitions for single-header implementation modules
...
// Global context pointer tracking the cleaner architecture structure
...
int main() {
    ...
    app_router = file_router_create(8080);
    if (!app_router) {
